...
## Вариант 365
## Описание задания
Доработать ИС из [ЛР1 (вариант №367156)](https://github.com/ahsokatyan/is1) следующим образом:
...
1. Текст задания.
1UML-диаграммы классов и пакетов разработанного приложения.
...
1. Jakarta Enterprise Beans (EJB). Виды бинов и их назначение
1. EJB Session beans. Жизненный цикл.
1. Понятие транзакции. Транзации в БД. ACID
1. Виды конфликтов при многопользовательской работе с данными. Уровни изоляции транзакций.
1. Особенности реализации транзакций на уровне бизнес-логики, отличия от транзакций на уровне БД.
1. Java Transaction API. Основные принципы и программные интерфейсы.
1. Реализация управления транзакциями в Jakarta EE. Декларативное и программное управление транзакциями.
1. Реализация управления транзакциями в Spring. Декларативное и программное управление транзакциями в Spring. Аннотация @Transactional.